    ...
    <div class="member">
      <a href="#">
        <div class="member_l">
          ...
          <span class="yuan">超级会员 .</span>
          <span class="yuan">每月领20元红包</span>
        </div>
        <div class="member_r">
          <span class="mai">立即开通 ></span>
        </div>
      </a>
    </div>
  </div>
